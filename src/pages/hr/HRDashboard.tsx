...
import { Users, Search, TrendingUp, ClipboardList, Calendar, FileText, UserPlus, BookOpen, FileBarChart, Network, Briefcase, LogOut } from 'lucide-react';
...
const DarkHRDashboard: React.FC = () => {
  ...
  // State definitions
  const [activeTab, setActiveTab] = useState<'Dashboard' | 'Employees' | 'Tasks' | 'Attendance' | 'Leave' | 'Payroll' | 'Recruitment' | 'Onboarding' | 'Reports' | 'Organization'>('Dashboard');
  ...
  const [formData, setFormData] = useState({ name: '', role: '', dept: '', salary: '', experience: '' });
  ...
  const [employees, setEmployees] = useState<Employee[]>([
    { id: 1, name: 'Shrushti Desu', role: 'Software Engineer', dept: 'Tech', salary: 85000, experience: 4, isMVP: true, joinDate: '2022-01-15' },
    { id: 2, name: 'Ananya Rao', role: 'Product Designer', dept: 'Design', salary: 72000, experience: 3, isMVP: false, joinDate: '2022-06-20' },
    { id: 3, name: 'Rahul Sharma', role: 'DevOps Lead', dept: 'Tech', salary: 95000, experience: 6, isMVP: false, joinDate: '2021-03-10' },
    { id: 4, name: 'Priya Singh', role: 'HR Manager', dept: 'Admin', salary: 65000, experience: 7, isMVP: false, joinDate: '2020-11-05' },
    { id: 5, name: 'Vikram Seth', role: 'Data Analyst', dept: 'Tech', salary: 78000, experience: 2, isMVP: false, joinDate: '2022-04-12' },
    { id: 6, name: 'Kavya Iyer', role: 'Frontend Developer', dept: 'Tech', salary: 80000, experience: 1, isMVP: true, joinDate: '2023-02-18' },
    { id: 7, name: 'Arjun Mehta', role: 'Backend Developer', dept: 'Tech', salary: 87000, experience: 3, isMVP: false, joinDate: '2022-08-10' },
    { id: 8, name: 'Sneha Patel', role: 'UI/UX Designer', dept: 'Design', salary: 70000, experience: 2, isMVP: false, joinDate: '2021-09-25' },
    { id: 9, name: 'Rohit Kumar', role: 'QA Engineer', dept: 'Tech', salary: 68000, experience: 5, isMVP: false, joinDate: '2020-12-30' },
    { id: 10, name: 'Meera Nair', role: 'HR Executive', dept: 'Admin', salary: 60000, experience: 0, isMVP: false, joinDate: '2023-01-05' },
    { id: 11, name: 'Siddharth Jain', role: 'Product Manager', dept: 'Admin', salary: 98000, experience: 4, isMVP: false, joinDate: '2021-07-14' },
    { id: 12, name: 'Pooja Reddy', role: 'Recruiter', dept: 'Admin', salary: 62000, experience: 1, isMVP: false, joinDate: '2022-03-22' },
    { id: 13, name: 'Karthik Reddy', role: 'Full Stack Developer', dept: 'Tech', salary: 92000, experience: 5, isMVP: true, joinDate: '2021-05-19' },
    { id: 14, name: 'Aisha Khan', role: 'Business Analyst', dept: 'Admin', salary: 75000, experience: 2, isMVP: false, joinDate: '2022-11-11' },
    { id: 15, name: 'Nikhil Verma', role: 'System Engineer', dept: 'Tech', salary: 83000, experience: 6, isMVP: false, joinDate: '2020-08-27' }
  ]);
  ...
  const resetEmployeeForm = () => {
    setFormData({ name: '', role: '', dept: '', salary: '', experience: '' });
      ...
      >
        ...
        <div className="relative z-10 flex h-full flex-col">
          <nav className="flex flex-1 flex-col gap-1.5 pt-1 min-h-0 overflow-hidden">
            <SidebarIcon icon={<TrendingUp size={20} />} label="Dashboard" active={activeTab === 'Dashboard'} onClick={() => setActiveTab('Dashboard')} />
            ...
            <SidebarIcon icon={<Calendar size={20} />} label="Leave" active={activeTab === 'Leave'} onClick={() => setActiveTab('Leave')} />
            ...
            <SidebarIcon icon={<BookOpen size={20} />} label="Onboarding" active={activeTab === 'Onboarding'} onClick={() => setActiveTab('Onboarding')} />
  ...
  >
    ...
    >
      ...
      <main className={`flex-1 flex flex-col relative z-10 overflow-visible transition-all duration-300 ${sidebarOpen ? 'ml-[280px]' : 'ml-[132px]'}`}>
        <DashboardNavbar
          title={activeTab === 'Dashboard' ? 'HR Dashboard' : activeTab === 'Tasks' ? 'Task Manager' : activeTab}
...
{activePage === 'profile' && (
  ...
  />
          ...
          {activeTab === 'Leave' && <LeaveModule />}
          {activeTab === 'Payroll' && <PayrollModule />}
          {activeTab === 'Recruitment' && <RecruitmentModule jobs={jobs} setJobs={setJobs} />}
          {activeTab === 'Tasks' && <TaskManager />}
          {activeTab === 'Onboarding' && <OnboardingModule employees={employees} setEmployees={setEmployees} onboardingEntries={onboardingEntries} setOnboardingEntries={setOnboardingEntries} documents={documents} setDocuments={setDocuments} isAddingOnboard={isAddingOnboard} setIsAddingOnboard={setIsAddingOnboard} onboardingForm={onboardingForm} setOnboardingForm={setOnboardingForm} handleAddOnboarding={handleAddOnboarding} handleUploadDocument={handleUploadDocument} handleMarkOnboarded={handleMarkOnboarded} handleMarkOffboarded={handleMarkOffboarded} />}
          {activeTab === 'Reports' && (
