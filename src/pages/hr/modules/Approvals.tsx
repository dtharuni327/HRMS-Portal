...
const ApprovalsModule: FC<ApprovalsModuleProps> = ({
  ...
  // leaveBalances removed — computed stats available via `employeeStats` above when needed
  ...
  const confirmRejectLeave = (leaveId: number) => {
              ...
              {allLeaveRequests.map((leave, index) => (
                ...
                >
                  ...
                  <td className="px-8 py-5 text-slate-700 font-medium">
                    <div className="space-y-1">
                      <div className="text-[11px] uppercase tracking-[0.18em] text-slate-500">From</div>
                      <div>{leave.startDate || '—'}</div>
                      {leave.endDate && (
                        <>
                          <div className="text-[11px] uppercase tracking-[0.18em] text-slate-500 mt-2">To</div>
