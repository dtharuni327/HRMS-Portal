...
const TaxReportsModule: FC = () => (
  <SparkCard className="rounded-[2rem] border border-white/10 bg-white/5 p-6 text-slate-100 shadow-[0_18px_45px_rgba(15,23,42,0.35)] backdrop-blur-xl">
    ...
    <h3 className="mt-3 text-xl font-black text-white">Tax Reports</h3>
    <p className="mt-2 text-sm text-slate-300">TDS, tax summary, deduction reports, and compliance tracking.</p>
  </SparkCard>
);
